...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) { // jshint ignore:line
        ...
        define(['src/main/webapp/WEB-INF/static/js/jquery'], factory); // jshint ignore:line
    } else { // noinspection JSUnresolvedVariable
        if (typeof module === 'object' && module.exports) { // jshint ignore:line
            // Node/CommonJS
            // noinspection JSUnresolvedVariable
            module.exports = factory(require('src/main/webapp/WEB-INF/static/js/jquery')); // jshint ignore:line
        } else {
            // Browser globals
